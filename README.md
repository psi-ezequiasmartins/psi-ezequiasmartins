...
Engenheiro de Software Full Stack Sênior com +35 anos de experiência em ambientes Desktop, Web e Mobile. Atualmente focado em sistemas para delivery, automação comercial e industrial, comunicação integrada e soluções eom assistência e suporte por Inteligência Artificial como CoPilot (Microsoft), Gemini (Google), Claude (Anthropic) e ChatGPT (OpenAI).
...
![Visual Studio Code](https://img.shields.io/badge/Visual%20Studio%20Code-007ACC?style=for-the-badge&logo=codecrafters&logoColor=white)
